  ...
  <div class="card rounded-lg">
      <div class="card-body">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Pengurusan Sesi Pengguna</a>
              </li>
          </ul>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="p-3">
                                                        <div class="d-flex flex-row justify-content-around align-items-center">
                                                            <a href="#" class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
