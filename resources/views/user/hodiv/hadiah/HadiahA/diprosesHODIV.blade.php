...
<div class="page-body p-4 text-dark">
  <!-- <div class="card-body"> -->
  <div class="buttons">
    <a href="{{route('user.hodiv.hadiah.listGift')}}" class="btn btn-light m-2">Sedang Diproses</a>
    <a href="{{route('user.hodiv.hadiah.HadiahA.diprosesHODIV')}}" class="btn btn-dark m-2">Diproses ke Ketua Jabatan Integriti</a>
