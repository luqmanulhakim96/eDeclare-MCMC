            ...
            <div class="card rounded-lg" >
                <div class="card-body">
                    ...
                    <div class="card-body">
                       ...
                       <form action="{{route('ulasanHODivGiftB.update', $listHadiah->id)}}" method="post">
                         @csrf
                       <div class="row">
                          <textarea name="ulasan_hod" rows="8" cols="50" placeholder="Ulasan Ketua Bahagian"></textarea><br>
                        </div>
                        <div class="row" align="left">
                          <input type="radio" id="tidak_lengkap" name="status" value="Tidak Lengkap">
                              <label for="Tidak Lengkap">Tidak Lengkap</label><br>
                          <input type="radio" id="diterima" name="status" value="Lengkap">
                              <label for="Lengkap">Lengkap</label><br>
                        </div>
                       <br>
                            <!-- button -->
                           <div class="row">
