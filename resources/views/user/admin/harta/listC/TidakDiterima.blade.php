...
@section('content')
           ...
           <div class="page-body p-4 text-dark">
             <div class="buttons">
               ...
               <a href="{{route('user.admin.harta.listC.TidakLengkap')}}"class="btn btn-danger m-2">Tidak Lengkap</a>
               <a href="{{route('user.admin.harta.listC.TidakDiterima')}}" class="btn btn-dark m-2" >Tidak Diterima</a>
             </div>
           <div class="row mt-10">
                   <!-- Col md 6 -->
