...
@section('content')
           ...
           <div class="page-body p-4 text-dark">
             <div class="buttons">
               ...
               <a href="{{route('user.admin.harta.listD.ProsesHOD')}}"class="btn btn-dark m-2">Diproses ke Ketua Jabatan Integriti</a>
               <a href="{{route('user.admin.harta.listD.Diterima')}}" class="btn btn-success m-2">Diterima</a>
               <a href="{{route('user.admin.harta.listD.TidakLengkap')}}"class="btn btn-danger m-2">Tidak Lengkap</a>
