...
@section('content')
           ...
           <div class="page-body p-4 text-dark">
             <div class="buttons">
               ...
               <a href="{{route('user.admin.harta.listG.ProsesHOD')}}"class="btn btn-warning m-2">Diproses ke Ketua Jabatan Integriti</a>
               ...
               <a href="{{route('user.admin.harta.listG.TidakDiterima')}}" class="btn btn-dark m-2" >Tidak Diterima</a>
             </div>
           <div class="row mt-10">
                   <!-- Col md 6 -->
