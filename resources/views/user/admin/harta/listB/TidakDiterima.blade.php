...
@section('content')
        ...
        <div class="page-body p-4 text-dark">
          <div class="buttons">
            <a href="{{route('user.admin.harta.listB.senaraiformB')}}"  class="btn btn-warning m-2">Sedang Diproses</a>
            <a href="{{route('user.admin.harta.listB.ProsesHOD')}}"class="btn btn-warning m-2">Diproses ke Ketua Jabatan Integriti</a>
            <a href="{{route('user.admin.harta.listB.Diterima')}}" class="btn btn-success m-2">Diterima</a>
            <a href="{{route('user.admin.harta.listB.TidakLengkap')}}"class="btn btn-danger m-2">Tidak Lengkap</a>
            <a href="{{route('user.admin.harta.listB.TidakDiterima')}}" class="btn btn-dark m-2" >Tidak Diterima</a>
          </div>
           <div class="row mt-10">
                   <!-- Col md 6 -->
