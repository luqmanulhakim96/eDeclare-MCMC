...
@section('content')
        ...
        <div class="page-body p-4 text-dark">
          <div class="buttons">
            ...
            <a href="{{route('user.admin.harta.listB.ProsesHOD')}}"class="btn btn-dark m-2">Diproses ke Ketua Jabatan Integriti</a>
            ...
            <a href="{{route('user.admin.harta.listB.TidakDiterima')}}" class="btn btn-danger m-2" >Tidak Diterima</a>
          </div>
           <div class="row mt-10">
                   <!-- Col md 6 -->
