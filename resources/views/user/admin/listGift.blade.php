                                ...
                                <div class="card rounded-lg">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Senarai Penerimaan Hadiah</a>
                                            </li>
                                            <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Sejarah Penerimaan Hadiah</a>
                                            </li>
                                            <li class="nav-item">
                                                                      ...
                                                                      <table class="table table-responsive text-dark">
                                                                          <thead class="thead-light">
                                                                              <tr class="text-center">
                                                                                ...
                                                                                <th width="10%"><p class="mb-0">Lampiran A</p></th>
                                                                      ...
                                                                      <table class="table table-responsive text-dark">
                                                                          <thead class="thead-light">
                                                                              <tr class="text-center">
                                                                                ...
                                                                                <th width="70%"><p class="mb-0">Tarikh</p></th>
                                                                                <th width="30%"><p class="mb-0">Status</p></th>
                                                                                <th width="30%"><p class="mb-0">Action</p></th>
                                                                              </tr>
                                                                          </thead>
                                                                          <tbody>
                                                                              <!-- Table data -->
                                                                              ...
                                                                              <tr class="text-center">
                                                                                  ...
                                                                                  <td><p class="mb-0 font-weight-bold">11-04-2019</p></td>
                                                                                  <td><span class="badge badge-danger badge-pill">Incompleted</span></td>
                                                                                  <td class="p-3">
                                                                                      <div class="d-flex flex-row justify-content-around align-items-center">
                                                                                          <a href="#"><i class="fas fa-pencil-alt text-success"></i></a>
                                                                                          <a href="#"><i class="fas fa-times-circle text-danger"></i></a>
