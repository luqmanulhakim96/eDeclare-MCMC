...
<div class="page-body p-4 text-dark">
  ...
  <div class="buttons">
    ...
    <a href="{{route('user.admin.hadiah.HadiahA.diprosesHODIV')}}" class="btn btn-dark m-2">Diproses ke Pentadbir Sistem</a>
    <a href="{{route('user.admin.hadiah.HadiahA.listDiterima')}}" class="btn btn-light m-2">Diterima</a>
    <a href="{{route('user.admin.hadiah.HadiahA.listTidakLengkap')}}"class="btn btn-light m-2">Tidak Lengkap</a>
