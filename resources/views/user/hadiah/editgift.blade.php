                              ...
                              <form action="{{route('gift.update', $info->id)}}" method="post" id="gift.submit" enctype="multipart/form-data">
                                ...
                                <p><b>1.KETERANGAN MENGENAI PEGAWAI</b></p>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-8">
                                          <input class="form-control bg-light" type="text" onkeypress="return onlyNumberKey(event)" name="nilai_hadiah" id="nilai_hadiah" placeholder="Nilai Hadiah/ Anggaran Nilai" value="{{ $info->nilai_gift  }}" >
                                      </div>
                                      @error('nilai_hadiah')
                                      <div class="alert alert-danger">
                                        <strong>{{ $message }}</strong>
