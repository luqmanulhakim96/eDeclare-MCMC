...
@section('content')
           ...
           <div class="page-body p-4 text-dark">
               <div class="page-heading border-bottom d-flex flex-row">
                   <p class="font-weight-normal">Lampiran A: LAPORAN PENERIMAAN HADIAH DIBAWAH SURAT PEKELILING PERKHIDMATAN DAN SOKONGAN BILANGAN 2 TAHUN 2015 BAGI HADIAH-HADIAH YANG BERNILAI RM 100 DAN KE BAWAH</p>
               </div>
                              ...
                              <form action="{{route('giftB.update', $info->id)}}" method="post">
                                ...
                                <p><b>1.KETERANGAN MENGENAI PEGAWAI</b></p>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-8">
                                        <input class="form-control bg-light" type="text" name="jenis_hadiah" id="jenis_hadiah" placeholder="Jenis Hadiah" value="{{ $info->jenis_gift  }}">
                                      </div>
                                      @error('jenis_hadiah')
