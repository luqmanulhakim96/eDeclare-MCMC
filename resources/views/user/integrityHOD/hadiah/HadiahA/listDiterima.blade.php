...
<div class="page-body p-4 text-dark">
  <!-- <div class="card-body"> -->
  <div class="buttons">
    <a href="{{route('user.integrityHOD.hadiah.listGift')}}" class="btn btn-light m-2">Sedang Diproses</a>
    <a href="{{route('user.integrityHOD.hadiah.HadiahA.diprosesHODIV')}}" class="btn btn-light m-2">Diproses ke Pentadbir Sistem</a>
    <a href="{{route('user.integrityHOD.hadiah.HadiahA.listDiterima')}}" class="btn btn-dark m-2">Diterima</a>
