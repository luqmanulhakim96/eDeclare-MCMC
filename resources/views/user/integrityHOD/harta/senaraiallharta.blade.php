                                         ...
                                         <tr>
                                             ...
                                             <td>
                                               @if($data ->getTable() == "formbs")
                                                 ...
                                                 <a href="{{route('user.integrityHOD.harta.ulasanHartaB',$data-> id)}}" class="btn btn-primary" >Ulasan</button>
                                                 @else
                                                 -
                                                 @endif
                                               @elseif($data ->getTable() == "formcs")
                                                 @if($data ->status == "Proses ke Ketua Jabatan Integriti")
                                                 <a href="{{route('user.integrityHOD.harta.ulasanHartaC',$data-> id)}}" class="btn btn-primary" >Ulasan</button>
                                                 @else
                                                 -
                                                 @endif
                                               @elseif($data ->getTable() == "formds")
                                                ...
                                                @elseif($data ->getTable() == "formgs")
                                                  @if($data ->status == "Proses ke Ketua Jabatan Integriti")
                                                  <a href="{{route('user.integrityHOD.harta.ulasanHartaG',$data-> id)}}" class="btn btn-primary" >Ulasan</button>
                                                  @else
                                                  -
                                                  @endif
                                                @endif
