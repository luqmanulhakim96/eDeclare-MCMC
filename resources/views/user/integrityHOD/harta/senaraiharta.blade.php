...
<div class="page-body p-4 text-dark">
  ...
  <div class="small-cards mt-5 mb-4">
      <div class="row">
          ...
          <a class="col-sm-6 col-md-6 col-lg-3 mt-4 mt-lg-0" href="{{route('user.integrityHOD.harta.senaraiformB')}}">
              <!-- Card -->
          ...
          <!-- Col sm 6, col md 6, col lg 3 -->
          <a class="col-sm-6 col-md-6 col-lg-3 mt-4 mt-lg-0" href="{{route('user.integrityHOD.harta.senaraiformC')}}">
              <!-- Card -->
              <div class="card border-0 rounded-lg">
                  <!-- Card body -->
                  <div class="card-body">
      ...
      <br>
      <!-- Col sm 6, col md 6, col lg 3 -->
      <a class="col-sm-6 col-md-6 col-lg-3 mt-4 mt-lg-0" href="{{route('user.integrityHOD.harta.senaraiformD')}}">
          <!-- Card -->
          <div class="card border-0 rounded-lg">
              <!-- Card body -->
              <div class="card-body">
      ...
      <a class="col-sm-6 col-md-6 col-lg-3 mt-4 mt-lg-0" href="{{route('user.integrityHOD.harta.senaraiformG')}}">
          <!-- Card -->
          <div class="card border-0 rounded-lg">
              <!-- Card body -->
              <div class="card-body">
