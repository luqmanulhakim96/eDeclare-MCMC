                  ...
                  <div class="col-12 mt-4">
                       ...
                       <div class="card rounded-lg">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-8">
                                <select id="jenis_harta" class="custom-select  bg-light" name="jenis_harta" value="{{$data->jenis_harta}}" >
                                    ...
                                    <option value="{{$jenisharta->jenis_harta}}" {{ $data->jenis_harta == $jenisharta->jenis_harta ? 'selected' : '' }}>{{$jenisharta->jenis_harta}}</option>
                                    @endif
                                    @endforeach
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <input class="form-control bg-light" type="text" id="pemilik_harta"  placeholder="Nama Pemilik" value="{{ $data->pemilik_harta}}" >
                            ...
                            <div class="col-md-4">
                                <select id="select_hubungan" class="custom-select  bg-light" >
                                    ...
                                    <option value="Sendiri" {{ $data->hubungan_pemilik   == "Sendiri" ? 'selected' : '' }}>Sendiri</option>
                                    <option value="Anak" {{ $data->hubungan_pemilik   == "Anak" ? 'selected' : '' }}>Anak</option>
                                    <option value="Isteri/Suami" {{ $data->hubungan_pemilik   == "Isteri/Suami" ? 'selected' : '' }}>Isteri/Suami</option>
                                    <option value="Ibu/Ayah" {{ $data->hubungan_pemilik   == "Ibu/Ayah" ? 'selected' : '' }}>Ibu/Ayah</option>
                                    <option value="Lain-lain" {{ $data->hubungan_pemilik   == "Lain-lain" ? 'selected' : '' }}>Lain-lain</option>
                                </select>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input class="form-control bg-light" type="text" id="maklumat_harta"  placeholder="Alamat Harta / No. Pendaftaran / No. Sijil Dan Sebagainya" value="{{ $data->maklumat_harta  }}" >
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input class="form-control bg-light" type="date" id="tarikh_pemilikan_harta"  value="{{ $data->tarikh_pemilikan_harta  }}" >
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input class="form-control bg-light" type="text" onkeypress="return onlyNumberKey(event)" id="bilangan"  placeholder="Bilangan / Ekar / kaki Persegi / Unit (kalau rumah, nyatakan keluasan tanah tapak rumah itu)" value="{{ $data->bilangan  }}" >
                              @error('bilangan_')
                                 <div class="alert alert-danger">{{ $message }}</div>
                             @enderror
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input class="form-control bg-light" type="text" onkeypress="return onlyNumberKey(event)" id="nilai_perolehan"  placeholder="Nilai Perolehan Harta (RM)" value="{{ $data->nilai_perolehan  }}" >
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                                <select id="cara_perolehan" class="custom-select  bg-light"  onchange="showCaraPerolehan()" >
                                    ...
                                    <option value="Dipusakai" {{ $data->cara_perolehan   == "Dipusakai" ? 'selected' : '' }}>Dipusakai</option>
                                    <option value="Dibeli" {{ $data->cara_perolehan   == "Dibeli" ? 'selected' : '' }}>Dibeli</option>
                                    <option value="Dihadiahkan" {{ $data->cara_perolehan   == "Dihadiahkan" ? 'selected' : '' }}>Dihadiahkan</option>
                                    <option value="Lain-lain" {{ $data->cara_perolehan   == "Lain-lain" ? 'selected' : '' }}>Lain-lain</option>
                                </select>
                            ...
                            <div id="nama_pemilikan_asal_container" style="display: none;">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="nama_pemilikan_asal"  placeholder="Nama Pemilik Sebelum" value="{{ $data->nama_pemilikan_asal  }}">
                            ...
                            <div id="lain-lain_container" style="display: none;">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="lain_lain"  value="{{ $data->lain_lain  }}">
                                  @error('lain_lain_')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <select id="cara_belian" class="custom-select  bg-light"  onchange="showCaraBelian()" >
                                      ...
                                      <option value="Pinjaman" {{ $data->cara_belian   == "Pinjaman" ? 'selected' : '' }}>Pinjaman</option>
                                      <option value="Pelupusan" {{ $data->cara_belian   == "Pelupusan" ? 'selected' : '' }}>Pelupusan</option>
                                  </select>
                                  @error('cara_belian_')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                            ...
                            <div id="pinjaman_container" style="display: none;">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" onkeypress="return onlyNumberKey(event)" type="text" id="jumlah_pinjaman"  value="{{ $data->jumlah_pinjaman  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="institusi_pinjaman"  value="{{ $data->institusi_pinjaman  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="tempoh_bayar_balik"  value="{{ $data->tempoh_bayar_balik  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" onkeypress="return onlyNumberKey(event)" type="text" id="ansuran_bulanan"  value="{{ $data->ansuran_bulanan  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="date" id="tarikh_ansuran_pertama"  value="{{ $data->tarikh_ansuran_pertama  }}">
                            ...
                            <div id="pelupusan_container" style="display: none;">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="jenis_harta_pelupusan"  value="{{ $data->jenis_harta_pelupusan  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="alamat_asset"  value="{{ $data->alamat_asset  }}">
                                  @error('alamat_asset_')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="text" id="no_pendaftaran"  value="{{ $data->no_pendaftaran  }}">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" onkeypress="return onlyNumberKey(event)" type="text" id="harga_jualan"  value="{{ $data->harga_jualan  }}">
                                  @error('harga_jualan_')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control bg-light" type="date" id="tarikh_lupus"  value="{{ $data->tarikh_lupus  }}">
                                  @error('tarikh_lupus_')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                                </div>
