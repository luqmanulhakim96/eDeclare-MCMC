                          ...
                          <div class="row">
                            ...
                            <div id="cara_belian_container" style="display: none;">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <select id="cara_belian" class="custom-select  bg-light" name="cara_belian" onchange="showCaraBelian()" >
                            ...
                            function showCaraPerolehan(){
                              var cara_perolehan= $('#cara_perolehan').val();

                              if(cara_perolehan == "Dipusakai" || cara_perolehan == "Dihadiahkan"){
           ...
           //for user to fill up the pinjaman
             ...
             $(add_button).click(function(e){ //on add input button click
               e.preventDefault();
                 ...
                 counter+
                 ']" placeholder="Nyatakan Lain-Lain Pinjaman"></div><div class="col-md-2"><input class="form-control bg-light" type="text" onchange="return copyCatPinjaman('+counter+')" name="pinjaman_pegawai['+
                 counter+
                 ']" id="pinjaman_pegawai['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="text" onchange="return copyCatPinjaman('+counter+')" name="bulanan_pegawai['+
                 counter+
                 ']" id="bulanan_pegawai['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="text" onchange="return copyCatPinjaman('+counter+')" name="pinjaman_pasangan['+
                 counter+
                 ']" id="pinjaman_pasangan['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="text" onchange="return copyCatPinjaman('+counter+')" name="bulanan_pasangan['+
                 counter+
                 ']" id="bulanan_pasangan['+
                 counter+
           ...
           //for form to capture user input and post it to backend
             ...
             $(add_button).click(function(e){ //on add input button click
               e.preventDefault();
                 ...
                 $(wrapper).append('<div id="divi_hidden'+counter+'"  class="row"><div class="col-md-3"><input class="form-control bg-light" type="hidden" name="lain_lain_pinjaman['+
                 counter+
                 ']" id="lain_lain_pinjaman_hidden['+
                 counter+
                 ']" placeholder="Nyatakan Lain-Lain Pinjaman"></div><div class="col-md-2"><input class="form-control bg-light" type="hidden" name="pinjaman_pegawai['+
                 counter+
                 ']" id="pinjaman_pegawai_hidden['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="hidden" name="bulanan_pegawai['+
                 counter+
                 ']" id="bulanan_pegawai_hidden['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="hidden" name="pinjaman_pasangan['+
                 counter+
                 ']" id="pinjaman_pasangan_hidden['+
                 counter+
                 ']"></div><div class="col-md-2"><input class="form-control bg-light" type="hidden" name="bulanan_pasangan['+
                 counter+
           ...
           <script type="text/javascript">
              ...
              $(add_button).click(function(e){ //on add input button click
                e.preventDefault();
                  ...
                  ']" id="dividen_1['+
                  counter_dividen+
                  ']" placeholder="Nyatakan Dividen"></div></div><div class="col-md-4 mt-2 mt-md-0"><div class="input-group"><input class="form-control bg-light" onchange="return copyCat('+counter_dividen+')" name="dividen_1_pegawai['+
                  counter_dividen+
                  ...
                  counter_dividen+
                  ']" placeholder="Dividen Pasangan" id="dividen_pasangan" onchange="return copyCat('+counter_dividen+')"></div><div class="col-md-1"><a onClick="removeDividen(this,'+
                  counter_dividen+
           ...
           <script type="text/javascript">
              ...
              $(add_button).click(function(e){ //on add input button click
                e.preventDefault();
                  ...
                  $(wrapper).append('<div id="dividen_add_hidden'+counter_dividen+'" class="row"><input type="hidden" name="dividen_1['+
                  counter_dividen+
                  ']" id="dividen_1_hidden['+
                  counter_dividen+
