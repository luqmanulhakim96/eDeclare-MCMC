           ...
           <div class="row mt-10">
                   ...
                   <div class="col-md-12 mt-4" >
                       ...
                       <div class="card rounded-lg" >
                           <div class="card-body">
                               <div class="card-title">Senarai Sejarah Perisytiharan Syarikat dan Perniagaan Sendiri</div>
                               <!-- Description -->
                                             ...
                                             <td class="p-3">
                                               <div class="d-flex flex-row justify-content-around align-items-center">
                                                 @if($data ->status == "Sedang Dikemaskini")
                                                   <a href="{{ route('user.harta.FormD.editformDNew', $data->id) }}" class="btn btn-success mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                 @elseif($data ->status == "Tidak Lengkap")
                                                 <a href="{{ route('user.harta.FormD.editformDNew', $data->id) }}" class="btn btn-success mr-1"><i class="fas fa-pencil-alt"></i></a>
