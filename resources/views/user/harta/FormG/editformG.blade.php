                               ...
                               <div class="card rounded-lg">
                                  ...
                                  <div class="saham" id="saham">
                                    <div class="row">
                                      ...
                                      <div class="col-md-2">
                                        <input type="text" class="form-control bg-light" id="ansuran_bulanan" name="ansuran_bulanan[]" placeholder="Ansuran Bulanan" value="{{ $data->ansuran_bulanan  }}">
                                      </div>
                                      <div class="col-md-2">
            ...
            <script type="text/javascript">
               ...
               $(add_button).click(function(e){ //on add input button click
                 e.preventDefault();
                   ...
                   counter_dividen+
                   '"><div class="col-md-4 mt-2 mt-md-0" id="dividen"><input class="form-control bg-light" id="dividen_1_pasangan[]" name="dividen_1_pasangan['+
                   counter_dividen+
