<div>
    ...
    <div id="dividen_field">
        <div class="row">
            ...
            <div class="col-md-1">
                <button class="btn btn-primary" wire:click.prevent="addformdividen({{ $j }})">Tambah</button>
            </div>
    ...
    <br>
    @foreach ($listDividenBs as $key => $value)
        @if ($key > 0)
            <div id="dividen_field">
                <div class="row">
                    <div class="col-md-3 mt-2 mt-md-0">
                        <div class="input-group">
                            <input class="form-control bg-light" type="text" wire:model="dividen_1.{{ $key }}"
                                placeholder="Nyatakan Dividen" autocomplete="off">
                    ...
                    <div class="col-md-4 mt-2 mt-md-0">
                        <div class="input-group">
                            <input class="form-control bg-light" wire:model="dividen_1_pegawai.{{ $key }}" {{-- onkeypress="" id="dividen0"/ --}}
                                onkeypress="return isNumberKey(event,this)" placeholder="Dividen Pegawai"
                                autocomplete="off">
                    ...
                    <div class="col-md-4 mt-2 mt-md-0">
                        <input class="form-control bg-light" wire:model="dividen_pasangan.{{ $key }}" {{-- onkeypress="" id="dividen0" --}}
                            onkeypress="return isNumberKey(event,this)" placeholder="Dividen Pasangan"
                            autocomplete="off">
                        @error('dividen_pasangan.0')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
