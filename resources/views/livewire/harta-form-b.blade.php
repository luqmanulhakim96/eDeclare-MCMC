<div wire:init='loadData'>
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control bg-light" type="text"
                                    wire:model="sumber_tunai" value="{{ old('sumber_tunai') }}" autocomplete="off">
                                    @error('sumber_tunai')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
          <button wire:click.prevent="storeHarta()" type="button" class="btn btn-primary" >Tambah Harta</button>
        </div>
    </div>
    @endif
