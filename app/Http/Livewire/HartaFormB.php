...
class HartaFormB extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.harta-form-b', compact('jenisHarta', 'staffinfo', 'maklumat_pasangan', 'maklumat_anak', 'dividen_user', 'last_data_formb', 'pinjaman_user'));
    }
