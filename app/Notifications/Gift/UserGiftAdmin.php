...
use App\Mail\Gift\EmailUserGiftAdmin;
use App\Mail\Gift\EmailUserGiftAdminNull;
use Illuminate\Support\Facades\Mail;

class UserGiftAdmin extends Notification
{
    use Queueable;
    use IsMonitored;
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserGiftAdmin($this->admin, $this->email));
        }
        else {
          return Mail::queue(new EmailUserGiftAdminNull($this->admin));
        }
    }
