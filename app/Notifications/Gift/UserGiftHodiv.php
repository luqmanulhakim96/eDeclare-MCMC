...
use App\Mail\Gift\EmailUserGiftHodiv;
use App\Mail\Gift\EmailUserGiftHodivNull;
use Illuminate\Support\Facades\Mail;

class UserGiftHodiv extends Notification
{
    use Queueable;
    use IsMonitored;
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserGiftHodiv($this->admin, $this->email));
        }
        else {
          return Mail::queue(new EmailUserGiftHodivNull($this->admin));
        }
    }
