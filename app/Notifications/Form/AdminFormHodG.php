...
use App\Mail\Form\EmailUserFormHODG;
use App\Mail\Form\EmailUserFormHODGNull;
use Illuminate\Support\Facades\Mail;
use romanzipp\QueueMonitor\Traits\IsMonitored;

class AdminFormHodG extends Notification
{
    use Queueable;
    use IsMonitored;
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserFormHODG($this->hod, $this->email));
        }
        else {
          return Mail::queue(new EmailUserFormHODGNull($this->hod));
        }
    }
