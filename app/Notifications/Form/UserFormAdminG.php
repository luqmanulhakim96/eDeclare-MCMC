...
use App\Mail\Form\EmailUserFormAdminG;
use App\Mail\Form\EmailUserFormAdminGNull;
use Illuminate\Support\Facades\Mail;
use romanzipp\QueueMonitor\Traits\IsMonitored;

class UserFormAdminG extends Notification
{
    use Queueable;
    use IsMonitored;
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserFormAdminG($this->admin, $this->email));
        }
        else {
          return Mail::queue(new EmailUserFormAdminGNull($this->admin));
        }
    }
