...
use App\Mail\Form\EmailUserFormHODC;
use App\Mail\Form\EmailUserFormHODCNull;
use Illuminate\Support\Facades\Mail;
use romanzipp\QueueMonitor\Traits\IsMonitored;

class AdminFormHodC extends Notification
{
    use Queueable;
    use IsMonitored;
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserFormHODC($this->hod, $this->email));
        }
        else {
          return Mail::queue(new EmailUserFormHODCNull($this->hod));
        }
    }
