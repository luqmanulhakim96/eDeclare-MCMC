...
use App\Mail\Form\EmailUserFormAdminB;
...
class UserFormAdminB extends Notification
{
    ...
    public function toMail($notifiable)
    {
        // dd($this->admin);
        if($this->email){
          return Mail::queue(new EmailUserFormAdminB($this->admin, $this->email));
        }
        else {
          return Mail::queue(new EmailUserFormAdminBNull($this->admin));
        }
    }
