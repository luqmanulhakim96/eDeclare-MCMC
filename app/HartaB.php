...
class HartaB extends Model
{
  ...
  protected $fillable = [
    'jenis_harta', 'pemilik_harta','hubungan_pemilik', 'maklumat_harta', 'tarikh_pemilikan_harta', 'bilangan',
    ...
    'tarikh_lupus','formbs_id','lain-lain','cara_belian','tarikh_pelupusan','cara_pelupusan','nilai_pelupusan'
  ];
