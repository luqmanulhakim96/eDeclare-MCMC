...
// class FormG extends Model
{
    ...
    protected $fillable = [
      'nama_pegawai','kad_pengenalan','jawatan','alamat_tempat_bertugas','gaji','tarikh_lantikan','nama_perkhidmatan','gelaran','nama_pegawai','kad_pengenalan','jawatan','alamat_tempat_bertugas','gaji','gaji_pasangan','jumlah_imbuhan','jumlah_imbuhan_pasangan', 'sewa','sewa_pasangan','pendapatan_pegawai','pendapatan_pasangan',
